class ConnectionMananger {
    constructor(tetrisMananger) {
        this.conn = null;
        this.peers = new Map;
        this.tetrisMananger = tetrisMananger;
    ...
    updateMananger(peers) {
        const me = peers.you;
        const clients = peers.clients.filter(client => me !== client.id);
        clients.forEach(client => {
            if (!this.peers.has(client.id)) {
                const tetris = this.tetrisMananger.createPlayer();
    ...
    recieve(msg) {
        ...
        if (data.type === 'session-created') {
            ...
            this.updateMananger(data.peers);
